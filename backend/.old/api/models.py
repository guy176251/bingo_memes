...
class Follow(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=["followee", "follower"], name="unique_follow")
        ]
...
class BingoCard(models.Model):
    ...
    author = models.ForeignKey(SiteUser, related_name="cards_created", on_delete=models.CASCADE)
    ...
    category = models.ForeignKey(BingoCardCategory, related_name="cards", on_delete=models.CASCADE)
