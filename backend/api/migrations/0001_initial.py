    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="api.bingocardcategory",
                    ),
                ),
                (
                    "user",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="api.siteuser"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cards",
                    models.ManyToManyField(related_name="hashtags", to="api.BingoCard"),
                ),
                (
                    "categories",
                    models.ManyToManyField(
                        related_name="hashtags", to="api.BingoCardCategory"
                    ),
                ),
            ],
            options={
